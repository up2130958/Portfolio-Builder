const experience = [
  {
    ...
    company: "Acme Corp",
    period: "2022 — Present",
    desc: "Lead engineer on the platform team. Redesigned the core data pipeline to handle 5× traffic growth, improved p99 latency by 60%, and mentored a team of 4 engineers.",
  ...
  },
  {
    ...
    company: "Widgets Inc",
    period: "2020 — 2022",
    desc: "Built and shipped real-time features for a SaaS analytics product used by 10k+ businesses. Led the migration from a monolith to microservices.",
  ...
  },
  {
    ...
    company: "StartupXYZ",
    period: "2018 — 2020",
    desc: "Full-stack development for an early-stage fintech startup. Implemented payment processing integrations and built out the customer-facing dashboard.",
...
function Tag({ label }: { label: string }) {
  return (
    <span className="text-xs font-bold uppercase tracking-widest border border-[#2A2A2A]/20 text-[#2A2A2A] px-2 py-0.5">
      {label}
    </span>
  );
}
      ...
      <div className="border-b border-[#2A2A2A]/10 pb-16 mb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            <h1 className="text-5xl md:text-7xl font-['Playfair_Display'] font-black leading-tight mb-8">
              About <span className="italic font-normal text-[#722F37]">Alex.</span>
            </h1>
            <blockquote className="font-['Playfair_Display'] text-2xl italic leading-snug text-[#722F37] border-l-2 border-[#722F37] pl-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            {experience.map((job) => (
              <div key={job.company} className="relative pl-5 border-l border-[#722F37]/30">
                ...
                <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                  <div>
                    <h3 className="font-['Playfair_Display'] font-bold text-xl">{job.role}</h3>
                ...
                <p className="text-[#5C5C5C] text-sm leading-relaxed mb-3 font-['Merriweather']">{job.desc}</p>
        ...
        <div className="space-y-8">
          <div className="border-t border-[#2A2A2A]/20 pt-6">
            <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5C5C5C] mb-3">Education</p>
            <h3 className="font-['Playfair_Display'] font-bold text-lg">B.S. Computer Science</h3>
          ...
          <div className="border-t border-[#2A2A2A]/20 pt-6">
            <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5C5C5C] mb-1">Location</p>
            <p className="font-['Playfair_Display'] font-bold text-lg">San Francisco, CA</p>
